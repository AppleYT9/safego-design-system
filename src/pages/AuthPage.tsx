    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[440px] rounded-3xl border border-white/20 bg-background/80 backdrop-blur-xl p-8 sm:p-10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
        <div className="mb-8 flex flex-col items-center">
          <Link to="/home" className="inline-block transition-transform hover:scale-105">
            <SafeGoLogo size={36} />
          </Link>
        </div>
        ...
        <form onSubmit={handleAuth} className="mt-6 flex flex-col gap-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-border py-3 text-sm font-medium transition-colors hover:bg-secondary"
          >
          ...
          <button type="submit" className="mt-2 w-full rounded-xl bg-primary py-4 text-sm font-semibold text-primary-foreground transition-all hover:brightness-110">
